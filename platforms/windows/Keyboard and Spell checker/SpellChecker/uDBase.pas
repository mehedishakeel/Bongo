     ...
     Try
          ...
          Except
               On E: Exception Do Begin
                    Application.MessageBox(Pchar('Cannot load Bongo database!' + #10 + '' + #10 + '-> Make sure ''Database.db3'' file is present in ' + GetAvroDataDir + ' folder, or' + #10 + '-> ''Database.db3'' file is not corrupt.' + #10 + '' + #10 + 'Reinstalling Bongo may solve this problem.' + #10 + 'Visit the Bongo GitHub repository for support.'), 'Bongo', MB_OK + MB_ICONHAND + MB_DEFBUTTON1 + MB_APPLMODAL);
               End;
          End;
     Finally
