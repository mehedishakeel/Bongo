...
Procedure TBongoMainForm1.AboutAvroKeyboard1Click(Sender: TObject);
Begin
		 CheckCreateForm(TfrmAbout, frmAbout, 'frmAbout');
		 frmAbout.Show;
End;

Procedure TBongoMainForm1.Aboutcurrentkeyboardlayout1Click(Sender: TObject);
Var
...
Procedure TBongoMainForm1.AboutCurrentskin1Click(Sender: TObject);
Var
		 SkinPath: String;
Begin
...
Procedure TBongoMainForm1.AutomaticallyfixChandrapositionInModernTypingStyle1Click(Sender: TObject);
Begin
		 ToggleFixChandra;
End;

Procedure TBongoMainForm1.AutomaticVowelFormatingInModernTypingStyle1Click(Sender: TObject);
Begin
		 ToggleVowelFormat;
End;
...
Procedure TBongoMainForm1.AvroPhoneticEnglishtoBangla3Click(Sender: TObject);
Begin
		 KeyLayout.CurrentKeyboardLayout := 'avrophonetic*';
End;

Procedure TBongoMainForm1.BanglaTypingwithAvroMouse1Click(Sender: TObject);
Begin
		 OpenHelpFile(28);
End;

Procedure TBongoMainForm1.BanglaTypingwithAvroPhonetic1Click(Sender: TObject);
Begin
		 OpenHelpFile(26);
End;

Procedure TBongoMainForm1.BanglaTypingwithFixedKeyboardLayouts1Click(Sender: TObject);
Begin
		 OpenHelpFile(27);
End;

Procedure TBongoMainForm1.BeforeYouStart1Click(Sender: TObject);
Begin
		 OpenHelpFile(23);
End;

Procedure TBongoMainForm1.ChangeTypingStyle(Const sStyle: String);
Begin
...
Procedure TBongoMainForm1.Charactermodeisdefault1Click(Sender: TObject);
Begin
		 PhoneticMode := 'CHAR';
		 RefreshSettings;
End;
...
Procedure TBongoMainForm1.Classicphoneticnohint1Click(Sender: TObject);
Begin
		 PhoneticMode := 'ONLYCHAR';
		 RefreshSettings;
End;

Procedure TBongoMainForm1.ComplexLanguageNotify;
...
Procedure TBongoMainForm1.Configuringyoursystem1Click(Sender: TObject);
Begin
		 Execute_Something(ExtractFilePath(Application.ExeName) + 'Configuring_system.htm');
End;

Procedure TBongoMainForm1.CreateParams(Var Params: TCreateParams);
Begin
		 Inherited CreateParams(Params);
		 Params.ExStyle := Params.ExStyle Or WS_EX_TOOLWINDOW And Not WS_EX_APPWINDOW;
End;

Procedure TBongoMainForm1.CreatingEditingFixedKeyboardLayouts1Click(Sender: TObject);
Begin
		 OpenHelpFile(35);
End;

Procedure TBongoMainForm1.CustomizingAvroKeyboard1Click(Sender: TObject);
Begin
		 OpenHelpFile(25);
End;

Procedure TBongoMainForm1.Dictionarymodeisdefault1Click(Sender: TObject);
Begin
		 PhoneticMode := 'DICT';
		 RefreshSettings;
End;

Procedure TBongoMainForm1.Docktotop1Click(Sender: TObject);
Begin
		 TopBarDocToTop;
End;
...
Procedure TBongoMainForm1.EnableAutoCorrect1Click(Sender: TObject);
Begin
		 ToggleAutoCorrect;
End;

Procedure TBongoMainForm1.EnableBanglainNumberPadInFixedkeyboardLayouts1Click(Sender: TObject);
Begin
		 ToggleNumPadBangla;
End;


Procedure TBongoMainForm1.EnableOldStyleRephInModernTypingStyle1Click(Sender: TObject);
Begin
		 ToggleOldStyleReph;
End;

Procedure TBongoMainForm1.Exit1Click(Sender: TObject);
Begin
		 Self.Close;
End;

Procedure TBongoMainForm1.ExitApp;
Begin
...
Procedure TBongoMainForm1.FontFixerSetdefaultBanglafont1Click(Sender: TObject);
Begin
		 Execute_Something(ExtractFilePath(Application.ExeName) + 'Font Fixer.exe');
End;

Procedure TBongoMainForm1.FormClose(Sender: TObject; Var Action: TCloseAction);
Begin
		 Action := caFree;
...
Procedure TBongoMainForm1.FormCloseQuery(Sender: TObject; Var CanClose: Boolean);
Begin
		 ExitApp;
		 CanClose := True;
End;

Procedure TBongoMainForm1.FormCreate(Sender: TObject);
Begin
		 // Hide the form
...
Procedure TBongoMainForm1.FormKeyDown(Sender: TObject; Var Key: Word; Shift: TShiftState);
Begin
...
Function TBongoMainForm1.GetMyCurrentLayout: String;
Begin
		 result := MyCurrentLayout;
End;

Procedure TBongoMainForm1.Helponhelp1Click(Sender: TObject);
Begin
		 Execute_Something(ExtractFilePath(Application.ExeName) + 'help_on_help.htm');
End;

Procedure TBongoMainForm1.HowtoBanglaChat1Click(Sender: TObject);
Begin
		 OpenHelpFile(31);
End;

Procedure TBongoMainForm1.HowtoBanglaFileFolderName1Click(Sender: TObject);
Begin
		 OpenHelpFile(30);
End;

Procedure TBongoMainForm1.HowtoDevelopBanglaWebPage1Click(Sender: TObject);
Begin
		 OpenHelpFile(33);
End;

Procedure TBongoMainForm1.HowtoEmbedBanglaFontinWebPages1Click(Sender: TObject);
Begin
		 OpenHelpFile(34);
End;

Procedure TBongoMainForm1.HowtoSearchingwebinBangla1Click(Sender: TObject);
Begin
		 OpenHelpFile(32);
End;

Procedure TBongoMainForm1.iComplexInstallcomplexscriptsupportinWindows1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.IdleTimerTimer(Sender: TObject);
Var
...
Function TBongoMainForm1.IgnorableWindow(Const lngHWND: HWND): Boolean;
Begin
		 result := False;
...
Procedure TBongoMainForm1.Initmenu;
Var
		 I, J: Integer;
...
Procedure TBongoMainForm1.Jumptosystemtray1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.KeyboardLayoutEditorBuildcustomlayouts1Click(Sender: TObject);
Begin
		 Execute_Something(ExtractFilePath(Application.ExeName) + 'Layout Editor.exe');
End;

Procedure TBongoMainForm1.KeyLayout_KeyboardLayoutChanged(CurrentKeyboardLayout: String);
Var
		 I: Integer;
Begin
...
Procedure TBongoMainForm1.KeyLayout_KeyboardModeChanged(CurrentMode: enumMode);
Var
		 hforewnd: Integer;
		 ICN: TIcon;
		 Locale: Cardinal;
...
Begin
		 ...
		 If IsFormVisible('TopBar') = False Then Begin
					...
					If CurrentMode = bangla Then Begin
							 ...
							 Tray.Hint := 'Bongo.' + #13 + 'Running Bangla Keyboard Mode.' + #13 + 'Press ' + ModeSwitchKey + ' to switch to System default.';
					End
					Else If CurrentMode = SysDefault Then Begin
							 If IsWin2000 = True Then
							 ...
							 Tray.Hint := 'Bongo.' + #13 + 'Running System default Keyboard Mode.' + #13 + 'Press ' + ModeSwitchKey + ' to switch to Bangla.';
					End;
					Tray.Icon := ICN;
					ICN.Free;
		 End
...
Procedure TBongoMainForm1.LoadApp;
Var
...
Procedure TBongoMainForm1.ManageAutoCorrectentries1Click(Sender: TObject);
Begin
		 CheckCreateForm(TfrmAutoCorrect, frmAutoCorrect, 'frmAutoCorrect');
		 frmAutoCorrect.Show;
End;

Procedure TBongoMainForm1.MenuFixedLayoutClick(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.ogglekeyboardmode2Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.OpenHelpFile(Const HelpID: Integer);
Begin
		 Case HelpID Of
					23:
...
Procedure TBongoMainForm1.Options1Click(Sender: TObject);
Begin
		 CheckCreateForm(TfrmOptions, frmOptions, 'frmOptions');
		 frmOptions.Show;
End;

Procedure TBongoMainForm1.OTFBanglaFontscamewithAvroKeyboard1Click(Sender: TObject);
Begin
		 Execute_Something(ExtractFilePath(Application.ExeName) + 'open_type_font_list.htm');
End;

Procedure TBongoMainForm1.OutputasANSIAreyousure1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.OutputasUnicodeRecommended1Click(Sender: TObject);
Begin
		 OutputIsBijoy := 'NO';
		 RefreshSettings;
...
Procedure TBongoMainForm1.Overview1Click(Sender: TObject);
Begin
		 OpenHelpFile(24);
End;
...
Procedure TBongoMainForm1.RefreshSettings;
Begin
...
Procedure TBongoMainForm1.Remembermychoiceamongsuggestions1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.ResetAllWindowLocale;
Var
		 I: HWND;
Begin
...
Procedure TBongoMainForm1.RestoreAvroTopBar1Click(Sender: TObject);
Begin
		 RestoreFromTray;
End;

Procedure TBongoMainForm1.RestoreFromTray;
Begin
...
Procedure TBongoMainForm1.Showactivekeyboardlayout1Click(Sender: TObject);
Begin
		 CheckCreateForm(TLayoutViewer, LayoutViewer, 'LayoutViewer');
		 LayoutViewer.Show;
End;

Procedure TBongoMainForm1.ShowOnTray;
Var
		 ICN: TIcon;
Begin
		 ICN := TIcon.Create;
		 ...
		 If StrToInt(TrayHintShowTimes) < NumberOfVisibleHints Then Begin
					Tray.BalloonHint := 'Bongo is running here.';
					Tray.BalloonTimeout := 5000;
					Tray.BalloonTitle := 'Bongo';
...
Procedure TBongoMainForm1.ShowPreviewWindow1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.SkinDesignerDesignyourownskin1Click(Sender: TObject);
Begin
		 Execute_Something(ExtractFilePath(Application.ExeName) + 'Skin Designer.exe');
End;

Procedure TBongoMainForm1.Spellcheck1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.ToggleAutoCorrect;
Begin
...
Procedure TBongoMainForm1.ToggleFixChandra;
Begin
...
Procedure TBongoMainForm1.ToggleMode;
Begin
		 KeyLayout.ToggleMode;
End;
...
Procedure TBongoMainForm1.ToggleNumPadBangla;
Begin
...
Procedure TBongoMainForm1.ToggleOldStyleReph;
Begin
...
Procedure TBongoMainForm1.ToggleOutputEncoding;
Begin
		 If OutputIsBijoy = 'YES' Then
...
Procedure TBongoMainForm1.ToggleVowelFormat;
Begin
...
Procedure TBongoMainForm1.TopBarDocToTop;
Begin
		 Topbar.Top := 0;
...
Function TBongoMainForm1.TransferKeyDown(Const KeyCode: Integer; Var Block: Boolean): String;
Begin
...
Procedure TBongoMainForm1.TransferKeyUp(Const KeyCode: Integer; Var Block: Boolean);
Begin
		 KeyLayout.ProcessVKeyUP(KeyCode, Block);
End;

Procedure TBongoMainForm1.TrayClick(Sender: TObject);
Begin
		 KeyLayout.ToggleMode;
End;

Procedure TBongoMainForm1.TrayDblClick(Sender: TObject);
Begin
		 KeyLayout.ToggleMode;
		 RestoreFromTray;
End;

Procedure TBongoMainForm1.TrimAppMemorySize;
Var
		 MainHandle: THandle;
Begin
		 Try
...
Procedure TBongoMainForm1.TypeJoNuktawithShiftJ1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.UnicodetoBijoytextconverter1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.UseOldStyleTyping1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.UseVerticalLinePipekeytotypeDot1Click(Sender: TObject);
Begin
...
Procedure TBongoMainForm1.WindowCheckTimer(Sender: TObject);
Var
...
Procedure TBongoMainForm1.WMCopyData(Var Msg: TWMCopyData);
Var
		 cmd: String;
Begin
