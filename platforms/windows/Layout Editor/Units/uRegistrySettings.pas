...
Procedure ValidateSettings;
Begin
     If Not (DirectoryExists(LELastDir)) Then LELastDir := GetAvroDataDir + 'Keyboard Layouts\';
     If Not (StrToInt(LETop) > 0) Then LETop := '50';
     If Not (StrToInt(LELeft) > 0) Then LELeft := '50';
     If Not (StrToInt(LEFontSize) > 7) Then LETop := '10';
End;
