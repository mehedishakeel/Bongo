...
let kConnectionName = "org.bongo.inputmethod.Bongo_Connection"

// IMKServer must be a global to stay alive for the process lifetime
var server: IMKServer!

// Build identifier — check Console.app for "Bongo" to verify which build is running
let bongoBuildId = "build-20260919a"
NSLog("Bongo: starting %@", bongoBuildId)
...
func installMainMenu() {
    ...
    let appMenu = NSMenu(title: "Bongo")
