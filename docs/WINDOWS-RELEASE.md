...
`platforms/windows/release/Bongo.exe`. The original Avro project remains for reference;
...
The phonetic method still uses the accurate name **Avro Phonetic**. Original
author notices remain in the source and license materials.
